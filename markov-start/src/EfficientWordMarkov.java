...
public class EfficientWordMarkov implements MarkovInterface<WordGram> {
	...
	// in the set training, a index map is built for easy searching 
	// the index_map = {word, {indices}}
	// in the get follows, when the wordgram is not in the wordMap
	// the first word of the wordgram is used to find the start index 
	// if strat from the start index, a wordgram equals the key can be built 
	// add the following word to the arraylist in the wordmap with key 
