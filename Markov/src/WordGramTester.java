...
public class WordGramTester {
	...
	public void testshiftAdd(){
		String[] words = {"apple", "zebra", "mongoose", "hat"};
		String new_word = "new";
		String[] after_shift = {"zebra", "mongoose", "hat", new_word};
		WordGram a = new WordGram(words,0,4);
		WordGram after_gram = new WordGram(after_shift, 0, 4);
		System.out.println(a.shiftAdd(new_word));
		System.out.println(after_gram);
		assertEquals("Fails on {apple, zebra, mongoose, hat} and new",a.shiftAdd(new_word).toString().equals(after_gram.toString()), true);
	}
}
